...
## Antworten
Salü! Klar, i hilf dir gern mit däm Fall. Hier d Antworten uf dini Frage, zuerst imene guet läsliche Format und dänn no als Tabelle:

**Antworte imene guet läsliche Format:**

*   **Parteien:**
    *   Klägerin: H.-B. (Tochter und Erbin von B.)
    *   Beklagte: Bank X (Rechtsnachfolgerin von Sparkasse Y)
    *   Nebenintervenientin: J. (Person, uf deren Name s Sparheft lauft)

*   **Sachverhalt:**
    *   1975 oder früher: B. eröffnet es Sparheft (Nr. 1) uf de Name vo J. bi de Sparkasse Y.
    *   17. Juli 1975: B. git s Sparheft de Sparkasse Y zur Ufbewahrig.
    *   Dezember 1989: B. stirbt und hinterlaat sini Tochter H.-B. als einzigi Erbin. S Sparheft isch immer no im Depot vo de Sparkasse Y.
    *   Bank X wird Rechtsnachfolgerin vo de Sparkasse Y.
    *   H.-B. verlangt vo de Bank X d Uuszahlung vom Sparheft-Saldo, aber d Bank verweigert das.

*   **Parteibegehren:**
    *   H.-B. will vo de Bank X d Uuszahlung vom Sparheft-Guthabe samt Zinsen (rund Fr. 70'000.-), will s Sparheft uf de Name vo J. lauft.

*   **Streitpunkt:**
    *   Isch H.-B. als Erbin vom B. berechtigt, über s Sparheft-Guthabe z verfüge, oder isch J. als die Person, uf deren Name s Sparheft lauft, berechtigt? Es gaht also drum, wer en Anspruch uf s Geld het.

*   **Position der Vorinstanzen:**
    *   Bezirksgericht Zürich: Klagabweisung.
    *   Obergericht Kanton Zürich: Bestätigung vom Urteil vom Bezirksgericht.

*   **Schlussfolgerung des Bundesgerichts:**
    *   D Berufung wird abgwiise, soweit druf iträte worde isch. S Bundesgericht het d Entscheidig vo de Vorinstanze bestätigt. Es het feschtgstellt, dass d Eröffnig vom Sparheft uf de Name vo J. en echte Vertrag zugunsten Dritter isch. D Bank X het sich druf verlah chönne, dass J. als die im Sparheft gnännti Person berechtigt isch. D Tatsache, dass B. s Sparheft bis zu sim Tod im Bsitz gha het, het nöd automatisch bedeutet, dass er d Begünstigung vo J. het welle widerriefe.

**Antworte als Tabelle:**

| Frage                         | Antwort                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Parteien                      | Klägerin: H.-B. (Erbin), Beklagte: Bank X, Nebenintervenientin: J.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Sachverhalt                   | B. eröffnet 1975 Sparheft Nr. 1 uf de Name vo J., hinterleit s Sparheft zur Ufbewahrig. B. stirbt 1989, H.-B. wird Erbin. Bank X wird Rechtsnachfolgerin. H.-B. verlangt Uuszahlung, Bank X verweigert.                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Parteibegehren                | H.-B. will vo de Bank X Uuszahlung vom Sparheft-Guthabe samt Zinsen.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Streitpunkt                   | Wer isch berechtigt über s Sparheft-Guthabe z verfüge? H.-B. als Erbin oder J. als im Sparheft gnännti Person?                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Position der Vorinstanzen      | Bezirksgericht Zürich: Klagabweisung. Obergericht Kanton Zürich: Bestätigung.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Schlussfolgerung Bundesgericht | Berufung wird abgwiise. Eröffnig vom Sparheft isch en Vertrag zugunsten Dritter. Bank X het sich druf verlah chönne, dass J. berechtigt isch. Bsitz vom Sparheft durch B. isch kei automatische Widerruf vo de Begünstigung.                                                                                                                                                                                                                                                                                                                                                                                                                     |

Ich hoffe, das hilft dir wiiter! Wenn du no meh Frage hesch, gib eifach Bescheid.
